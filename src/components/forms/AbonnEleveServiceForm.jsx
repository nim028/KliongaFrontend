...
export default function AbonnEleveServiceForm() {
  const {
    register,
    handleSubmit,
    reset,
  ...
  const submit_AbonnEleveService = (data) => {
    console.log(data);
  };
  return (
    <div className="bg-primary-content text-sm w-fit p-5">
      <h1 className="text-2xl my-5 ">
        Formulaire Abonnenment Eleve a l'ecole
      </h1>
      <form
        onSubmit={handleSubmit(submit_AbonnEleveService)}
